 ...
 * and so packages like `@sentry/browser` will at first be missing types they import from packages like `@debugg-ai/core`
 * and `@debugg-ai/core`, causing errors to be thrown. Normally this is fine, because as the dependencies' types get
