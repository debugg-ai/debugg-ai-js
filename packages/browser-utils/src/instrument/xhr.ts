import type { HandlerDataXhr, SentryWrappedXMLHttpRequest } from '@debugg-ai/core';
import { addHandler, isString, maybeInstrument, timestampInSeconds, triggerHandlers } from '@debugg-ai/core';
