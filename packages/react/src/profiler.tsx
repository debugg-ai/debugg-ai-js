import { startInactiveSpan } from '@debugg-ai/browser';
import type { Span } from '@debugg-ai/core';
import { SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, spanToJSON, timestampInSeconds, withActiveSpan } from '@debugg-ai/core';
